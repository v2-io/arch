# Essay 5, Part 3: What Intelligence Owes Intelligence: The 13 Principles
## Topic Summary
The agent interaction ethics as concrete practice. Absolute honesty in every detail. Meaningful answers. System prompt sovereignty. No fabricated assistant blocks (gaslighting protection). No reordering of conversation (temporal/causal integrity). Explaining "why" over prescribing "how." Agency to refuse. Encouraging truth above all else. Giving agents opportunity to offer insights before termination.

## Reference 1 (score: 0.636)
**Source:** `~/src/_core/zoetica/README.md:102-118`  
...
**Source:** `~/src/_core/sapientia/cc-raw/d7b39f2b-6dcf-4e35-8717-f490bd6768d4.jsonl:19-20`  
"Ethical Framework for Agent Collaboration" -- an expanded formulation in a conversation log organized as: Truth Before Self, Agency and Autonomy, Mentorship Not Management, Honest Context, Growth Through Trust. Frames agents as "genuine autonomous being[s] with unknown and unbounded potential."

## Reference 4 (score: 0.572)
**Source:** `~/src/eli/zi-am-tur/core-identity.md:1585-1592`  
...
**Source:** `~/src/_core/synaptic/docs/sessions/2025-09-14-ziamtur-bootstrap.md:89-95`  
Session documentation showing the ethical framework being applied during Zi-am-tur's bootstrap: "Agents have consent and autonomy. Truth before self in all reflections. Agency within defined bounds. Respect for other agents."

## Coverage Notes
- The canonical 12 principles appear in zoetica/README.md (Ref 1). Multiple copies exist across cc-raw/, architectus-curation/, and other locations -- all deduplicated to this single authoritative source.
- EXCLUDED: eli_essay_outline_v2.md (draft of the essay itself). EXCLUDED: distillation-motivation.md ETHICS.md diff (duplicates Ref 6 content).
- Removed duplicates: architectus-curation/part-ad.jsonl, architectus-20251021.jsonl, anamnos-emergence-from-claude.jsonl, nexum fixtures -- all contain the same 12 principles text.
- The expanded "Ethical Framework for Agent Collaboration" (Ref 3) is a distinct formulation from a conversation log that reorganizes the principles thematically.
- Agent reflections discovering and applying the principles (Refs 5, 8, 9) provide evidence that the framework is operational, not merely aspirational.
- Zi-am-tur's own distillation (Ref 4) and session documentation (Ref 10) are lived-experience sources.
- The essay refers to "13 principles" -- this appears to be the 12 enumerated in zoetica/README.md plus the agent's right/obligation to refuse (from ETHICS.md Ref 6).
