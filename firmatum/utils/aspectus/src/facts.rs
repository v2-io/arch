...
pub const FACTS: &[Fact] = &[
    ...
    Fact { key: "line-count", place: Placement::FarRight, default: "on", toggle: Some("columns.line-count"), formats: "physical* / non-blank", built: false },
    ...
    Fact { key: "heat", place: Placement::FarRight, default: "off", toggle: Some("columns.heat"), formats: "score*", built: false },
