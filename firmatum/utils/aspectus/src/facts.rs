...
pub const FACTS: &[Fact] = &[
    ...
    Fact { key: "initial-sha", place: Placement::FarRight, default: "off", toggle: Some("columns.initial-sha"), formats: "short* / h~n / full", built: true },
    Fact { key: "latest-sha", place: Placement::FarRight, default: "off", toggle: Some("columns.latest-sha"), formats: "short* / h~n / full", built: true },
    Fact { key: "prior-name", place: Placement::NearRight, default: "quiet", toggle: Some("columns.prior-name"), formats: "was*", built: false },
    Fact { key: "readme-title", place: Placement::NearRight, default: "off", toggle: Some("readme-title"), formats: "quoted*", built: true },
    Fact { key: "gitignored", place: Placement::NearRight, default: "on", toggle: None, formats: "glyph*", built: true },
