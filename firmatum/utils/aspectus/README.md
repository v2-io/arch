...
The look of a locus. Print-and-quit. For agents first.

The faculty is **aspectus**. One snapshot it produces is an **aspecta**.

**Pipeline and progress:** [`ASPECTUS.outline.md`](ASPECTUS.outline.md). **Live effort:** [`PRACTICA.md`](PRACTICA.md).

```sh
cargo run -- --help
cargo install --path firmatum/utils/aspectus   # from arch/
```
