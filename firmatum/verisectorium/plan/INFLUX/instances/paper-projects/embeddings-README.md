<!--
  ...
  Provenance: embeddings/README.md (TACL hedge-geometry; docs/ notes, no OUTLINE+segments observed)
  Copied: 2026-08-05
  Source path at copy time: /Users/josephwecker-v2/src/embeddings/README.md
  Do not edit here expecting to update the live original.
-->

# Experiments in Epistemic Hedging Geometries

...

## Bayesian Degree of Belief

The standard view: "Degree of belief" is a philosophical interpretation of the probability calculus — a choice you make about what the formalism means.
