...
- Discharges TODO entries N19 (the ladder, and the three acts) and R42's routing half (the disposition vocabulary a report uses to route a finding — landed here as the report-as-routing-artifact case rather than as its own segment).
