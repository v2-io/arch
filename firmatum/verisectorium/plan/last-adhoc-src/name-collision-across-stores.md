...
- Intake artifact behind this segment, now at `plan/.integrated/vera/00-INDEX.md` and **not** to be cited as warrant: its hand-written collision table is the thing this segment is *about*. That table's content is superseded by the table above; the live paths listed are what the body stands on.
