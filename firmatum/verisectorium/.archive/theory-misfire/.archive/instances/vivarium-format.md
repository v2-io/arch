<!--
  ...
  Provenance: arch/vivarium/FORMAT.md (same shape, different domain; status/stage split; may never want ASF partial-order gates)
  Copied: 2026-08-05
  Source path at copy time: /Users/josephwecker-v2/src/arch/vivarium/FORMAT.md
