...
|---------------|-----------------------|------------------------------|-------------------------------------------------------------|---------------------|-----------------|
| override      | directive             | [[dir-orient]]               | Orientation index & instructions-- Link target of ORIENT.md | supported           | ruled           |
| template      | directive             | [[dir-disposition]]          | Agentic instructions on disposition/attitude generally      | supported           | ratified        |
...
| template      | reference             | [[ref-verisectorium-tools]]  | The tools Verisectorium ships / makes available — maintained upstream as they evolve; built vs planned split honestly | supported | current |
...
| override      | reference             | [[ref-hazards]]              | Named hazards, so nobody re-learns them (seeded empty; every instance accrues its own) | supported | current |
