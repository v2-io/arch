...
- **File hygiene:** `md-press --check` every touched `.md` before reporting it done. md-press will not run on udon files (`.ud`/`.un`/`.udon`) unless it is forced to (no udon linter/canonicalizer exists quite yet).
