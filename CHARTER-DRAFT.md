...
|---|---|---|---|
| **Proved** | `asf` (ASF/AAT) | derivations, no-gos, bounds, typed scope conditions | its CLAUDE.md (= `doc/sop/agents.sop.md`) + FORMAT |
...
| **Constructed** | `vivarium` | authored worlds where every AAT quantity has ground truth by construction; the participation taxonomy | its CLAUDE.md + ETHICS.md (Standing Moratorium + AAT-scope mapping) + LEXICON |
